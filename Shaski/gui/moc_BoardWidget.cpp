/****************************************************************************
** Meta object code from reading C++ file 'BoardWidget.hpp'
**
...
#error "The header file 'BoardWidget.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_BoardWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_BoardWidget_t qt_meta_stringdata_BoardWidget = {
    {
QT_MOC_LITERAL(0, 11) // "BoardWidget"
...
const QMetaObject BoardWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_BoardWidget.offsetsAndSize,
    qt_meta_data_BoardWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_BoardWidget_t
